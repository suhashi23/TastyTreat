...
<html>
  ...
  <head>
    <title> Contact | Tasty Treat </title>
  </head>
...
?>
  ...
  <div class="aboutsec" style="background-image:url('images/contactbg.jpg');, background-repeat:no-repeat; background-size: cover;">
    <div class="heading" style="background: none;">
     <strong>Want to contact <span class="edit" style="color:rgb(66, 109, 174)"> Tasty Treat </span>?</strong>
    </div>
    ...
    <br>
      ...
      <div class="form-area" style="opacity:0.8;">
