<html>
<head>
    <title> Guest Signup | TastyTreat </title>
  </head>
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">TastyTreat</a>
        </div>
    ...
    <div class="customersignup" style="background-image:url('images/managerloginbg.jpg');,background-repeat:no-repeat; background-size: cover;">
    <div class="container" >
    <div class="jumbotron" style="background:none">
     <h1 style="color: black">Hi Guest, <br> Welcome to <span class="edit" style="text-shadow: 5px 3px 3px rgb(66, 109, 174);color: black"> TastyTreat </span></h1>
     <br>
      ...
      <div class="panel panel-primary" style="background-color: rgb(46, 43, 47);">
        ...
        <form role="form" action="customer_registered_success.php" method="POST">
          ...
          <div class="form-group col-xs-12">
            <label for="fullname" style="color:white;"><span class="text-danger" style="margin-right: 5px;">*</span> Full Name: </label>
