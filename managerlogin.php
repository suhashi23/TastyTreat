...
<html>
  ...
  <head>
    <title> Manager Login | Tasty Treat </title>
  </head>
  ...
  <body>
    ...
    <div class="managaerlogin" style="background-image:url('images/custbg1.jpg');,background-repeat:no-repeat; background-size: cover;">
    <div class="container">
    <div class="jumbotron" style="background:none">
     <h1 style="color: black">Hi Manager,<br> Welcome to <span class="edit" style="text-shadow: 5px 3px 3px rgb(66, 109, 174);
  color: black;"> TastyTreat </span></h1>
     <br>
   <p style="color: black">Kindly LOGIN to continue.</p>
    </div>
    </div>
